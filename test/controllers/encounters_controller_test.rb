...
class EncountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encounter" do
    assert_difference('Encounter.count') do
      post encounters_url, params: { encounter: { admitted_at: @encounter.admitted_at, bed: @encounter.bed, discharged_at: @encounter.discharged_at, location: @encounter.location, room: @encounter.room, visit_no: @encounter.visit_no } }
    end
  ...
  test "should update encounter" do
    patch encounter_url(@encounter), params: { encounter: { admitted_at: @encounter.admitted_at, bed: @encounter.bed, discharged_at: @encounter.discharged_at, location: @encounter.location, room: @encounter.room, visit_no: @encounter.visit_no } }
